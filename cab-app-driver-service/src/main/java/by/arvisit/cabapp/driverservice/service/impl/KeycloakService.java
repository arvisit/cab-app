...
public class KeycloakService {
    ...
    private static final String EMAIL_ALREADY_IN_USE_MESSAGE_TEMPLATE_KEY = "by.arvisit.cabapp.driverservice.service.impl.KeycloakService.UsernameAlreadyExistsException.template";
    private static final String NOT_FULLNAME_MESSAGE_TEMPLATE_KEY = "by.arvisit.cabapp.driverservice.service.impl.KeycloakService.IllegalArgumentException.template";
    ...
    public String addUser(DriverRequestDto dto) {
        ...
        addClientRoleToUser(username, DRIVER_ROLE);
