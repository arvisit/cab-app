...
@SelectClasspathResource("by/arvisit/cabapp/paymentservice/e2e")
@ConfigurationParameter(key = Constants.GLUE_PROPERTY_NAME, value = "by.arvisit.cabapp.paymentservice.e2e")
