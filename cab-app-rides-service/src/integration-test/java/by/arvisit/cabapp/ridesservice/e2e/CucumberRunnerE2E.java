...
@SelectClasspathResource("by/arvisit/cabapp/ridesservice/e2e")
@ConfigurationParameter(key = Constants.GLUE_PROPERTY_NAME, value = "by.arvisit.cabapp.ridesservice.e2e")
