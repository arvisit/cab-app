...
import by.arvisit.cabapp.ridesservice.util.RideITData;
...
public class BaseTestClass {
    ...
    public void setup() {
        ...
        when(rideService.getRideById(RideITData.CONTRACT_RIDE_PAYMENT_ID))
                .thenReturn(RideITData.getRideForPayment().build());
    }
}
